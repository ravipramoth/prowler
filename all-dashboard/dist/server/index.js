globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-B2cfiRlZ.js","assets/layout-segment-context-RZLybxaD.js"];
...
function getDraftSecret() {
	return "b91c66c1-46c9-40a7-b8b7-75239647b10e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "6e273dca-f076-41ea-9547-fc52d945916b";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "6e273dca-f076-41ea-9547-fc52d945916b") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "6e273dca-f076-41ea-9547-fc52d945916b",
		rootBoundaryId
	});
}
/**
...
var page_exports = /* @__PURE__ */ __exportAll({
	...
	parseProwler: () => parseProwler,
	parseProwlerCompliance: () => parseProwlerCompliance,
	parseTrivy: () => parseTrivy,
	parseZap: () => parseZap
});
var parseProwler = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'parseProwler' is called on server");
}, "6efdf509a785", "parseProwler");
var parseProwlerCompliance = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'parseProwlerCompliance' is called on server");
}, "6efdf509a785", "parseProwlerCompliance");
var parseZap = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'parseZap' is called on server");
}, "6efdf509a785", "parseZap");
var parseTrivy = /* @__PURE__ */ registerClientReference(() => {
	throw new Error("Unexpectedly client reference export 'parseTrivy' is called on server");
}, "6efdf509a785", "parseTrivy");
...
async function generateMetadata() {
	...
	return {
		...
		openGraph: {
			title: "SentinelScope",
			description: "Security findings, made clear.",
			images: [{
				url: "/og.png",
				width: 1200,
				height: 630
...
//#endregion
//#region app/api/security-chat/route.ts
var route_exports = /* @__PURE__ */ __exportAll({
	GET: () => GET,
	POST: () => POST
});
var MAX_FINDINGS = 50;
var MAX_FIELD_LENGTH = 1800;
...
function extractOutputText(payload) {
	...
	return (Array.isArray(payload.output) ? payload.output : []).flatMap((item) => {
		...
		return (Array.isArray(item.content) ? item.content : []).flatMap((part) => part && typeof part === "object" && typeof part.text === "string" ? [part.text] : []);
	}).join("\n").trim();
}
async function GET() {
...
async function POST(request) {
	...
	const question = clean(body.question, 2e3).trim();
	...
	const findings = sourceFindings.map((value) => {
		const finding = value && typeof value === "object" ? value : {};
		return {
			id: clean(finding.id, 240),
			title: clean(finding.title, 500),
			severity: clean(finding.severity, 30),
			status: clean(finding.status, 80),
			asset: clean(finding.asset, 500),
			location: clean(finding.location, 800),
			category: clean(finding.category, 200),
	...
	if (!upstream.ok) {
		const upstreamError = payload.error && typeof payload.error === "object" ? clean(payload.error.message, 500) : "OpenAI could not complete the analysis.";
...
var routes = [{
	...
	ids: {
		"route": "route:/api/security-chat",
		"page": null,
		"routeHandler": "route-handler:/api/security-chat",
		"rootBoundary": "root-boundary:/",
		"layouts": ["layout:/"],
		"templates": [],
		"slots": {}
	},
	pattern: "/api/security-chat",
	patternParts: ["api", "security-chat"],
	isDynamic: false,
	params: [],
	rootParamNames: [],
	page: null,
	...
	layouts: [layout_exports],
	routeSegments: ["api", "security-chat"],
	templateTreePositions: [],
	layoutTreePositions: [0],
	templates: [],
	errors: [null],
